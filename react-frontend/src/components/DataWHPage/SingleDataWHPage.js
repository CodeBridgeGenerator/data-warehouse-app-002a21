...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Timestamps</label><p className="m-0 ml-3" ><i id="timestamps" className={`pi ${_entity?.timestamps?"pi-check": "pi-times"}`}  ></i></p></div>
