...
const p_booleanTemplate3 = (rowData, { rowIndex }) => <p >{String(rowData.timestamps)}</p>
...
<Column field="timestamps" header="Timestamps" body={p_booleanTemplate3} filter={selectedFilterFields.includes("timestamps")} hidden={selectedHideFields?.includes("timestamps")}  style={{ minWidth: "8rem" }} />
